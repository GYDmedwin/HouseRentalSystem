...
public class MainView extends JFrame {
	...
	static String yu_e, deng_lu = "denglu", zhu_ce = "zhuce", shou_ye = "shouye", woshi_fangzhu = "woshifangzhu",
			shai_xuan = "shaixuan", _find = "find", nicheng;
	Box top, vbox, mid;
	...
	static JLabel in, bac, loge, Loge, back, mfangxing, mhuxing, mshengfeng, mjiage, mshiqu, mxie, mfangxing2, mhuxing2,
			mshengfeng2, mjiage2, mdizhi, mshiqu2, mxie2, back1, yonghu;
	...
	public MainView() {
		...
		String[] backimage = { "D:\\eclipsePractice\\HouseRentalSystem\\image\\loge.jpeg",
				"D:\\eclipsePractice\\HouseRentalSystem\\image\\youname3.jpg",
				"D:\\eclipsePractice\\HouseRentalSystem\\image\\youname1.jpg" };
	...
	private JComponent createshouye() {
		...
		Loge = new JLabel(new ImageIcon("D:\\eclipsePractice\\HouseRentalSystem\\image\\youname1.jpg"));
		Loge.setBounds(0, 0, 700, 95);
		back = new JLabel();
		back.setIcon(new ImageIcon("D:\\eclipsePractice\\HouseRentalSystem\\image\\youname1.jpg"));
		back.setBounds(220, 100, 900, 400);
		in = new JLabel();
		in.setIcon(new ImageIcon("D:\\eclipsePractice\\HouseRentalSystem\\image\\timg.jpg"));
	...
	private JComponent createwodefangwu() {
		...
		back1 = new JLabel(new ImageIcon("D:\\eclipsePractice\\HouseRentalSystem\\image\\youname.jpg"));
	...
	private static JComponent createfangwu() {
		// scrollPane = new
		// JScrollPane(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		...
		ActionListener listener = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (shou_ye.equals(command)) {
					int result = JOptionPane.showConfirmDialog(jf, "确认添加？", "提示", JOptionPane.YES_NO_CANCEL_OPTION);
